		...
		<div class="band band-white">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-4 product-image">
						<img src="assets/img/img_dell-poweredge.jpg" alt="product meta" />
<!--						<img class="thumb" src="assets/img/img_dell-poweredge-thumb.jpg" alt="product meta" />-->
<!--						<img class="thumb" src="assets/img/img_dell-poweredge-thumb.jpg" alt="product meta" />-->
<!--						<img class="thumb" src="assets/img/img_dell-poweredge-thumb.jpg" alt="product meta" />-->
					</div>
				</div>
								...
								<div id="features" class="tab-pane">
									<h2 class="section-title"><i class="fa fa-key"></i>Key Features and Benefits</h2>
										<ul class="row">
											<li class="col-sm-6">
												<h4>Stability</h4>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A culpa cum dolorum id illum impedit libero magnam maxime nisi nobis obcaecati praesentium, quaerat repellendus sint veritatis. Aliquid eum reprehenderit rerum!</p>
											</li>
											<li class="col-sm-6">
									...
									<div class="row">
										<div class="col-sm-6">
											<h2 class="section-title"><i class="fa fa-language"></i>Supported Languages</h2>
											<ul>
												<li>English</li>
												<li>Korean</li>
												<li>Spanish</li>
										...
										<div class="col-sm-6">
											<h2 class="section-title"><i class="fa fa-globe"></i>Supported Regions</h2>
											<ul>
												<li>EMEA</li>
												<li>US</li>
											</ul>
									...
									<div class="row">
										<div class="col-sm-6">
											<h2 class="section-title"><i class="fa fa-pie-chart"></i>Category</h2>
											<ul>
												<li>Server</li>
												<li>Desktop</li>
												<li>Component</li>
